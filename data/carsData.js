const carsData = [
    {
      ...
      price: 41399,
      description:
        "While rival muscle cars have pivoted recently toward sharp handling, the 2023 Dodge Challenger keeps things retro with a package thatâ€™s designed more for old-school pony-car jollies and straight-line speed. A V-6 engine is standard in these non-SRT Challengers but the real fun comes with the optional naturally aspirated Hemi V-8 engines, which are offered in a variety of displacements and outputs spanning a 375-hp, 5.7-liter to a 485-hp, 6.4-liter. If you want even more power, Dodge will be happy to oblige with the big-stomper Challenger SRT Hellcat, which we review separately. The regular Challenger isnâ€™t as intense as the outrageous Hellcat, but for some its V-8 burble and relatively comfortable ride will be enough to trigger nostalgic feelings for the vintage Dodge pony cars with which it shares a name.",
    ...
    },
    {
      ...
      price: 24149,
      description:
        "The A5 Sportback is a great-looking, fun-handling, smooth-driving premium sedan that isnâ€™t as aggressive as the 349-hp S5 Sportback, which we review separately. As an lengthened version of the A5 coupe and convertible, the A5 Sportback uses an identical powertrain setup with a turbocharged inline-four bolted to a seven-speed dual-clutch automatic transmission and all-wheel drive. A5 Sportback 40 model has 201 horsepower and 236 pound-feet of torque, while A5 Sportback 45 model gains an additional 60 horsepower and 40 pound-feet of torque. A rich breadth of standard niceties such as high-quality leather, a panoramic sunroof, and moody ambient lighting make even the base A5 Sportback feel plush. While rivals such as the Mercedes-Benz C-class or Genesis G70 have arguably more stylish interiors, the Sportbackâ€™s is butressed by an incredibly clear and high-tech digital gauge display with available navigation handled by Google Earth imagery.",
    ...
    },
    {
      ...
      price: 35199,
      description:
        "Few cars are capable of serving the gods of both comfort and sportiness as well as the 2023 BMW 3-series sedan. This perennial favorite can be outfitted as a corner-carving sports sedan or a well-appointed entry-luxury carâ€”or a combination of both. Its three available turbocharged powertrains deftly walk the line between power and polish. The entry-level 330i and plug-in hybrid 330e offer impressive performance with above average fuel economy, while the turbocharged inline-six in the top-dog M340i packs 382 of the biggest, strongest horses this side of the Bavarian Alps. The 3-series doesnâ€™t have the style of the Alfa Romeo Giulia or the value-packed features list of the Genesis G70, but itâ€™s so well-rounded, athletic, and engaging to drive that it stands at the very top of our segment rankings. BMWâ€™s quintessential sports sedan gets a tech-heavy makeover for 2023 that sees updated exterior styling and a dramatic new all-digital dashboard. Keen eyes will notice that this same monolithic display that stretches two-thirds of the 3-seriesâ€™s dashboard is the same design as what youâ€™ll find in the brandâ€™s flagship 7-series and electric iX SUV. The wall of screens runs BMWâ€™s iDrive 8 interface and includes standard navigation, a voice assistant, and a 5G Wi-FI hotspot.",
    ...
    },
    {
      ...
      price: 34499,
      description:
        "The BMW 1 Series has been a staple contender among premium family hatchbacks for many years, appealing to anyone looking to mix practicality with a dose of glamour. This latest, third-generation 1 Series has one big change that's upset a few enthusiasts, though â€“ it's driven by its front wheels rather than being rear-wheel drive. However, for most buyers, that's actually made it a far more accomplished family car. أ¥You see, the truth is, previous generations of the BMW 1 Series werenâ€™t as good to drive as the 'Ultimate Driving Machine' hype suggested anyway, with only more powerful (and expensive) versions able to take full advantage of the rear-wheel-drive layout. أ¥On this latest model, BMW gives you a choice of petrol and diesel engines, and you can get four-wheel drive for extra road-holding on some of the pricier versions. Indeed, many of the mechanicals are taken from the BMW X1 and BMW X2 SUVs. أ¥Here, we'll be finding out how the BMW 1 Series stacks up against a range of alternatives, such as the Audi A3 and Mercedes A-Class â€“ as well as more mainstream alternatives, including the Mazda 3 and Volkswagen Golf. We'll also tell you which engine and trim combination make the most sense.",
